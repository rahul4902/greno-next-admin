      ...
      <LayoutWithHeaderFooter>
        ...
        <section class="py-5">
          <div class="container"> 
            ...
            <a href="#" class="badge rounded-pill text-bg-light py-3 px-4 fw-semibold fs-5 me-2 mb-2">Salty kettle Corn</a>
            <a href="#" class="badge rounded-pill text-bg-light py-3 px-4 fw-semibold fs-5 me-2 mb-2">Chobani Greek Yogurt</a>
            <a href="#" class="badge rounded-pill text-bg-light py-3 px-4 fw-semibold fs-5 me-2 mb-2">Sweet Vanilla Yogurt</a>
            <a href="#" class="badge rounded-pill text-bg-light py-3 px-4 fw-semibold fs-5 me-2 mb-2">Foster Farms Takeout Crispy wings</a>
            <a href="#" class="badge rounded-pill text-bg-light py-3 px-4 fw-semibold fs-5 me-2 mb-2">Warrior Blend Organic</a>
            <a href="#" class="badge rounded-pill text-bg-light py-3 px-4 fw-semibold fs-5 me-2 mb-2">Chao Cheese Creamy</a>
          </div>
        </section>
        <section class="py-5">
          <div class="container">
            <div class="row">
              <div class="col">
                <div class="bg-light rounded p-2 mb-3 border-0">
                  <div class="row">
