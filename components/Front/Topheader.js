          ...
          <div className="container d-flex flex-wrap">
            <ul className="nav">
              <li className="nav-item">
                <a href="" rel="nofollow" target="_blank" className="nav-link link-dark px-2" title="Follow Us On Facebook">
              ...
              <li className="nav-item">
                <a href="" rel="nofollow" target="_blank" className="nav-link link-dark px-2" title="Follow Us On Instagram">
              ...
              <li className="nav-item">
                <a href="" rel="nofollow" target="_blank" className="nav-link link-dark px-2" title="Follow Us On Twitter">
              ...
              <li className="nav-item">
                <a href="" rel="nofollow" target="_blank" className="nav-link link-dark px-2" title="Follow Us On Linkedin">
            ...
            <ul className="nav d-none d-sm-flex ms-auto">
              <li className="nav-item">
                <a href="" className="nav-link link-dark px-2">Privacy policy</a>
              </li>
              <li className="nav-item">
                <a href="" className="nav-link link-dark px-2">Disclaimer</a>
              </li>
              <li className="nav-item">
                <a href="" className="nav-link link-dark px-2 border-0">Contact</a>
              </li>
            </ul>
          </div>
        </nav>
